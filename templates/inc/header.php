<header id="header">
    <div class="container">
        <div class="logo">
            <a href="/">
                <img alt="Porto" width="111" height="54" data-sticky-width="82" data-sticky-height="40" src="{{ asset('../porto/img/logo.png') }}">
            </a>
        </div>
        <div class="search">
        ...
        <nav>
            <ul class="nav nav-pills nav-top">
                ...
                <li class="phone">
                    <span><i class="fa fa-phone"></i>(0157) 597 247 90</span>
                </li>
            </ul>
        </nav>
                                        ...
                                        <div class="col-md-3">
                                            <ul class="sub-menu">
                                                <li>
                                                    ...
                                                    <ul class="sub-menu">
                                                        <li><a href="/#footer">Footer 1</a></li>
