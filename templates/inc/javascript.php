...
<script src="{{ asset('porto/vendor/bootstrap/bootstrap.js') }}"></script>
...
<script src="{{ asset('porto/vendor/owlcarousel/owl.carousel.js') }}"></script>
<script src="{{ asset('porto/vendor/jflickrfeed/jflickrfeed.js') }}"></script>
